...
const SearchInput = () => {
    ...
    return (
        <div className="relative overflow-hidden  z-50">
            {/* Main Container */}
            <div className="lg:flex max-w-[1400px] mx-auto px-4 lg:px-12 items-center py-4  gap-12 lg:text-left text-center">
                {/* Left Section */}
                <motion.section
                    className="flex-1"
            ...
            {/* Search Bar Section */}
            <div className="relative bg-white  max-w-6xl mx-auto -mt-10 p-4 lg:p-6 flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-6">
                {/* Date Input */}
                <div
                ...
                <div className=''>
                    <div className="h-[47.7px] w-[36px] bg-white absolute top-0 right-[-34px] clip-triangle shadow-lg"></div>
                    <div className="h-[47.7px] w-[36px] bg-white absolute top-0 left-[-34px] clip-triangle-left shadow-lg"></div>
                </div>
